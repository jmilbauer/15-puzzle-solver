    ...
    def solve(self):
        ...
        while len(OpenSet) != 0:
            ...
            for neighbor in neighbors:
                ...
                tentative_f_score = tentative_g_score + neighbor.h_cost_est() # change line to "tentative_f_score = neighbor.h_cost_est()" to
                                                                              # convert algorithm into best-first search
